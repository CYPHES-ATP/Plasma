...
export const DESKTOP_MENU: DesktopMenu[] = [
  ...
  },
  {
    ...
    label: "Help",
    items: [
      { type: "item", label: "Plasma Documentation", href: "https://github.com/CYPHES-ATP/Plasma#readme" },
      { type: "item", label: "Project Discussions", href: "https://github.com/CYPHES-ATP/Plasma/discussions" },
      { type: "item", label: "Export Logs...", command: "logs.export" },
      { type: "separator" },
      {
        type: "item",
        label: "Share Feedback",
        href: "https://github.com/CYPHES-ATP/Plasma/issues/new",
      },
      {
        type: "item",
        label: "Report a Bug",
