...
export function SessionHeader() {
  ...
  const v2ActionsState = createMemo<SessionHeaderV2ActionsState>(() => ({
    ...
    onSecurity: () => navigate(`/${params.dir}/plasma`),
            ...
            <Show
              ...
              fallback={
                <div class="flex items-center gap-2">
                  <Button variant="ghost" size="small" icon="shield" onClick={() => navigate(`/${params.dir}/plasma`)}>
                    Security
                  </Button>
  ...
  return (
    <div class="flex items-center gap-2">
      <Button
        ...
        onClick={props.state.onSecurity}
      >
        {props.state.securityLabel}
      </Button>
