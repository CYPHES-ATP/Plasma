...
export default function Page() {
  ...
  createEffect(() => {
    ...
    const path = searchParams.plasmaFile
    const line = Number(searchParams.plasmaLine)
    ...
    setSearchParams({ ...searchParams, plasmaFile: undefined, plasmaLine: undefined }, { replace: true })
  })
