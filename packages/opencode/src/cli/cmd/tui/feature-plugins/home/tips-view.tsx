...
const TIPS: Tip[] = [
  ...
  "Create a plugin to prevent Plasma from reading sensitive files",
  "Use {highlight}plasma run{/highlight} for non-interactive scripting",
  "Use {highlight}plasma --continue{/highlight} to resume the last session",
  "Use {highlight}plasma run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}plasma serve{/highlight} for headless API access to Plasma",
  "Use {highlight}plasma run --attach{/highlight} to connect to a running server",
  "Run {highlight}plasma upgrade{/highlight} to update to the latest version",
  "Run {highlight}plasma auth list{/highlight} to see all configured providers",
  "Run {highlight}plasma agent create{/highlight} for guided agent creation",
  ...
  "Run {highlight}plasma debug config{/highlight} to troubleshoot configuration",
  ...
  "Use {highlight}/connect{/highlight} to configure the model provider you trust",
