...
export const Flag = {
  ...
  PLASMA_SERVER_PASSWORD: process.env["PLASMA_SERVER_PASSWORD"] ?? process.env["OPENCODE_SERVER_PASSWORD"],
  PLASMA_SERVER_USERNAME: process.env["PLASMA_SERVER_USERNAME"] ?? process.env["OPENCODE_SERVER_USERNAME"],
