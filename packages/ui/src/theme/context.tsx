...
const STORAGE_KEYS = {
  THEME_ID: "plasma-theme-id",
  COLOR_SCHEME: "plasma-color-scheme",
  THEME_CSS_LIGHT: "plasma-theme-css-light",
  THEME_CSS_DARK: "plasma-theme-css-dark",
} as const
...
export const { use: useTheme, provider: ThemeProvider } = createSimpleContext({
  ...
  init: (props: { defaultTheme?: string; onThemeApplied?: (theme: DesktopTheme, mode: "light" | "dark") => void }) => {
    ...
    onMount(() => {
      ...
      const savedTheme = normalize(rawTheme ?? props.defaultTheme) ?? "opencode"
