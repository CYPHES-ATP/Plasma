...
const APP_IDS: Record<string, string> = {
  dev: "ai.cyphes.plasma.dev",
  beta: "ai.cyphes.plasma.beta",
  prod: "ai.cyphes.plasma",
}
...
const main = Effect.gen(function* () {
  ...
  const appId = app.isPackaged ? APP_IDS[CHANNEL] : "ai.cyphes.plasma.dev"
  ...
  app.setName(app.isPackaged ? APP_NAMES[CHANNEL] : "Plasma Dev")
  ...
  app.on("second-instance", (_event: Event, argv: string[]) => {
    const urls = argv.filter((arg: string) => arg.startsWith("plasma://") || arg.startsWith("opencode://"))
    if (urls.length) {
