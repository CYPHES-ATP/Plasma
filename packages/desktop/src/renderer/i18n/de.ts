export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von Plasma",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von Plasma wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
