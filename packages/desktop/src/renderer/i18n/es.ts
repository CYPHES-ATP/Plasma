export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Plasma",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Plasma. ¿Quieres instalarla y reiniciar?",
